...
//public class NumMesh
//{
//    public Mesh mesh;
//    public NumMesh(Vector3[] vertices, Vector2[] uvs, int[] triangles)
//    {
//        if (mesh == null)
//        {
//            mesh = new Mesh();
...
{
    GameObject[,] pointGos;
	bool ynShowPoints = true;
    float speed = 1;
    float cycle = 0;
    float cycle2 = 0;
//    int cntFrames;
    float amplitude = 1;
	public int numLengthDivs = 10 - 1;
	public int numRadDivs = 10 - 1;
